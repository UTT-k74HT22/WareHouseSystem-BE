...
DROP TEMPORARY TABLE IF EXISTS tmp_rbac_role_grants;
CREATE TEMPORARY TABLE tmp_rbac_role_grants (
    role_name VARCHAR(50) NOT NULL,
    permission_code VARCHAR(100) NOT NULL,
    PRIMARY KEY (role_name, permission_code)
);

INSERT INTO tmp_rbac_role_grants (role_name, permission_code)
VALUES
    ('USER', 'PERM_PERMISSION_READ'),
    ('USER', 'PERM_ROLE_READ'),
    ('USER', 'PERM_USER_READ'),
    ('USER', 'PERM_CATEGORY_READ'),
    ('USER', 'PERM_BUSINESS_PARTNER_READ'),
    ('USER', 'PERM_WAREHOUSE_CREATE'),
    ('USER', 'PERM_WAREHOUSE_READ'),
    ('USER', 'PERM_WAREHOUSE_UPDATE'),
    ('USER', 'PERM_WAREHOUSE_DELETE'),
    ('USER', 'PERM_LOCATION_CREATE'),
    ('USER', 'PERM_LOCATION_READ'),
    ('USER', 'PERM_LOCATION_UPDATE'),
    ('USER', 'PERM_LOCATION_DELETE'),
    ('USER', 'PERM_UNIT_OF_MEASURE_CREATE'),
    ('USER', 'PERM_UNIT_OF_MEASURE_READ'),
    ('USER', 'PERM_UNIT_OF_MEASURE_UPDATE'),
    ('USER', 'PERM_UNIT_OF_MEASURE_DELETE'),
    ('USER', 'PERM_PRODUCT_CREATE'),
    ('USER', 'PERM_PRODUCT_READ'),
    ('USER', 'PERM_PRODUCT_UPDATE'),
    ('USER', 'PERM_PRODUCT_DELETE'),
    ('USER', 'PERM_INVENTORY_READ'),
    ('USER', 'PERM_INVENTORY_RESERVATION_UPDATE'),
    ('USER', 'PERM_INVENTORY_MUTATION_UPDATE'),
    ('USER', 'PERM_BATCH_CREATE'),
    ('USER', 'PERM_BATCH_READ'),
    ('USER', 'PERM_BATCH_UPDATE'),
    ('USER', 'PERM_PURCHASE_ORDER_CREATE'),
    ('USER', 'PERM_PURCHASE_ORDER_READ'),
    ('USER', 'PERM_PURCHASE_ORDER_UPDATE'),
    ('USER', 'PERM_PURCHASE_ORDER_DELETE'),
    ('USER', 'PERM_PURCHASE_ORDER_LINE_CREATE'),
    ('USER', 'PERM_PURCHASE_ORDER_LINE_READ'),
    ('USER', 'PERM_PURCHASE_ORDER_LINE_UPDATE'),
    ('USER', 'PERM_PURCHASE_ORDER_LINE_DELETE'),
    ('USER', 'PERM_INBOUND_RECEIPT_CREATE'),
    ('USER', 'PERM_INBOUND_RECEIPT_READ'),
    ('USER', 'PERM_INBOUND_RECEIPT_UPDATE'),
    ('USER', 'PERM_INBOUND_RECEIPT_DELETE'),
    ('USER', 'PERM_INBOUND_RECEIPT_LINE_CREATE'),
    ('USER', 'PERM_INBOUND_RECEIPT_LINE_READ'),
    ('USER', 'PERM_INBOUND_RECEIPT_LINE_UPDATE'),
    ('USER', 'PERM_INBOUND_RECEIPT_LINE_DELETE'),
    ('USER', 'PERM_SALES_ORDER_CREATE'),
    ('USER', 'PERM_SALES_ORDER_READ'),
    ('USER', 'PERM_SALES_ORDER_UPDATE'),
    ('USER', 'PERM_SALES_ORDER_LINE_CREATE'),
    ('USER', 'PERM_SALES_ORDER_LINE_READ'),
    ('USER', 'PERM_SALES_ORDER_LINE_UPDATE'),
    ('USER', 'PERM_STOCK_TRANSFER_CREATE'),
    ('USER', 'PERM_STOCK_TRANSFER_READ'),
    ('USER', 'PERM_STOCK_TRANSFER_UPDATE'),
    ('USER', 'PERM_STOCK_MOVEMENT_READ'),
    ('USER', 'PERM_STOCK_ADJUSTMENT_CREATE'),
    ('USER', 'PERM_STOCK_ADJUSTMENT_READ'),
    ('USER', 'PERM_STORAGE_CREATE'),
    ('USER', 'PERM_STORAGE_READ'),
    ('USER', 'PERM_REPORT_CURRENT_STOCK_READ');

INSERT INTO tmp_rbac_role_grants (role_name, permission_code)
SELECT 'MANAGER', permission_code
FROM tmp_rbac_role_grants
WHERE role_name = 'USER';

INSERT INTO tmp_rbac_role_grants (role_name, permission_code)
VALUES
    ('MANAGER', 'PERM_EMPLOYEE_READ'),
    ('MANAGER', 'PERM_OUTBOUND_SHIPMENT_CREATE'),
    ('MANAGER', 'PERM_OUTBOUND_SHIPMENT_READ'),
    ('MANAGER', 'PERM_OUTBOUND_SHIPMENT_UPDATE'),
    ('MANAGER', 'PERM_OUTBOUND_SHIPMENT_LINE_CREATE'),
    ('MANAGER', 'PERM_OUTBOUND_SHIPMENT_LINE_READ'),
    ('MANAGER', 'PERM_OUTBOUND_SHIPMENT_LINE_UPDATE'),
    ('MANAGER', 'PERM_OUTBOUND_SHIPMENT_LINE_DELETE'),
    ('MANAGER', 'PERM_STORAGE_DELETE');

INSERT INTO role_permissions (role_id, permission_id)
SELECT r.id, p.id
FROM tmp_rbac_role_grants rg
JOIN roles r ON r.name = rg.role_name
